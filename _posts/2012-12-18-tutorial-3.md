...
<a href="http://shinobukawano.com/2012/12/tutorial-2/">前回</a>、Sencha Cmd を使って、プロジェクトの雛形を作成しました。それでは、メモ帳アプリの開発を始めましょう。前回 app.js の launch 関数に追加した Ext.Msg.alert は不要なので消して下さい。
...
<a href="http://vimeo.com/56164595">Sencha Touch 2.1 based Memo app.</a> from <a href="http://vimeo.com/shinobukawano">shinobukawano</a> on <a href="https://vimeo.com">Vimeo</a>.
...
<a href="http://shinobukawano.com/2012/12/tutorial-4/">次回</a>は、作成フォームを作りましょう。
