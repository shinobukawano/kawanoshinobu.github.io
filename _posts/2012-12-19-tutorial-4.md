...
<a href="http://shinobukawano.com/2012/12/tutorial-3/">前回</a>のエントリで、一覧画面を作成しました。今回は、作成画面を作り、タイトルバー右上の「+」ボタンを押して、作成画面に遷移できるようにします。
...
useTitleForBackButtonText　に true を指定することで、遷移前の画面タイトルを、戻るボタンのキャプションにすることができます。<a href="http://shinobukawano.com/2012/12/tutorial-5/">次回</a>は、データの保存や更新、削除処理を実装しましょう。
